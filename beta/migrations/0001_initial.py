# Generated by Django 3.1.6 on 2021-07-05 12:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeStamp', models.CharField(blank=True, help_text='Time data was collected', max_length=255, null=True)),
                ...
                ('employmentStatus', models.CharField(choices=[('Student', 'Student'), ('Employed', 'Employed'), ('Self-Employed', 'Self-Employed')], default='Student', max_length=255, null=True)),
                ...
                ('rentMonthly', models.PositiveIntegerField(default=500, help_text='What is the total monthly rent for the property?', null=True)),
