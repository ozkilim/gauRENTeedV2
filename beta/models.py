...
class Property(models.Model):
    fullAddress = models.CharField(
        unique=True, max_length=500, default="", blank=True)

    postcode = models.CharField(
        unique=False, max_length=500, default="", blank=True)
...
class Review(models.Model):
    ...
    timeStamp = models.CharField(
        null=True, blank=True, help_text='Time data was collected', max_length=500)
    ...
    employmentStatus = models.CharField(null=True,
                                        choices=USER_OCCUPATION_CHOICES, default="Student", max_length=500
                                        )

    reviewerName = models.CharField(max_length=500, null=True)
    ...
    buildigComment = models.CharField(
        null=True, blank=True, help_text='Can you explain why you have given it the rating that you have?', max_length=500)
    ...
    manageResponsivenesComment = models.CharField(
        null=True, blank=True, help_text='Can you explain why you have given them the rating that you have?', max_length=500)
    ...
    hiddenExpenses = models.CharField(
        null=True, blank=True, help_text='Were there any hidden expenses at the end of the tenancy? (Cleaning costs, significant deposit reductions, unexpected charges, etc) ', max_length=500)

    wantedToKnowBefore = models.CharField(
        null=True, blank=True, help_text='Is there anything else you would have liked to have known about the property manager before you moved in?', max_length=500
    )
    ...
    neighbourhoodDescription = models.CharField(
        null=True, blank=True, help_text='How would you describe the neighbourhood to someone thinking of living there?', max_length=500)
    ...
    likedMost = models.CharField(
        null=True, blank=True, help_text='What do/did you like most about the property?', max_length=500)

    likedLeast = models.CharField(
        null=True, blank=True, help_text='What do/did you like least about the property?', max_length=500)
    ...
    email = models.CharField(
        null=True, blank=True, help_text='email', max_length=500)
    ...
    whoSentSurvey = models.CharField(
        null=True, blank=True, help_text='Who sent you this survey? (Leave blank if you scanned the QR code on our leaflet)', max_length=500)
    ...
    qualityComments = models.CharField(
        null=True, blank=True, help_text='Any other comment about the quality of property?', max_length=500)
    ...
    landlordComments = models.CharField(
        null=True, blank=True, help_text='LANDLORD: Any other comments', max_length=500)

    areaBenefits = models.CharField(
        null=True, blank=True, help_text='What were the benefits of the area?', max_length=500)

    areaPerks = models.CharField(
        null=True, blank=True, help_text='Perks of area', max_length=500)
